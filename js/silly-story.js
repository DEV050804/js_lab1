...
var randomize_Story = document.getElementById("randomize_Story");
...
*/
var story_Text = 'It was 94 farenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared in horror for a few moments, then :insertz:. Bob saw the whole thing, but he was not surprised — :insertx: weighs 300 pounds, and it was a hot day.';
...
randomize_Story.addEventListener("click", result);
...
function result() {
    ...
    new_Story = new_Story.replace(":insertx:", xItem);
    new_Story = new_Story.replace(":insertx:", xItem);
    new_Story = new_Story.replace(":inserty:", yItem);
    new_Story = new_Story.replace(":insertz:", zItem);    
    ...
    if (custom_Name.value !== "") {
        new_Story = new_Story.replace("Bob", custom_Name.value);
    }
    ...
    if (document.getElementById("metric").checked) {
        ...
        new_Story = new_Story.replace("300 pounds", weight.toFixed(2) + " kg");
        ...
        new_Story = new_Story.replace("94 farenheit", temp.toFixed(2) + " Celsius");
    }
